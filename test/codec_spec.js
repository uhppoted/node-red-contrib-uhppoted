...
describe('codec', function () {
  describe('#encode(...)', function () {
    ...
    it('should encode add-task request', function () {
      const msg = Buffer.from([
        ...
        0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x08, 0x30, 0x03, 0x04, 0x07, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
      ])
    ...
    it('should encode set-interlock', function () {
      ...
      const bytes = codec.encode(opcodes.SetInterlock, 405419896, { interlock: 4 })
    ...
    it('should encode activate-keypads request', function () {
      ...
      const bytes = codec.encode(opcodes.ActivateKeypads, 405419896, { keypads: { 1: true, 2: true, 3: false, 4: true } })
  ...
  describe('#decode(...)', function () {
    ...
    it('should decode get-time response', function () {
      ...
      const msg = Buffer.from([
        0x17, 0x32, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x20, 0x24, 0x10, 0x07, 0x09, 0x45, 0x57, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
      ])
