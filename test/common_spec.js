...
describe('common', function () {
  describe('resolve controller ID', function () {
    it('should resolve a legacy uint32 deviceId argument', function () {
      const { id, address, protocol } = resolve({ deviceId: 405419896 })
    ...
    it('should resolve a uint32 controller argument', function () {
      const { id, address, protocol } = resolve({ controller: 405419896 })
    ...
    it('should resolve an object controller ID', function () {
      const { id, _address, _protocol } = resolve({ controller: { id: 405419896 } })
  ...
  describe('resolve controller address', function () {
    it('should resolve a missing controller address argument', function () {
      const { id, address, protocol } = resolve({ controller: { id: 405419896, protocol: 'tcp' } })
    ...
    it('should resolve a controller address {address,port} argument', function () {
      const { _id, address, protocol } = resolve({ controller: { address: { address: '192.168.1.100', port: 12345 }, protocol: 'tcp' } })
    ...
    it('should resolve a controller {address} argument', function () {
      const { _id, address, protocol } = resolve({ controller: { id: 405419896, address: { address: '192.168.1.100' }, protocol: 'tcp' } })
    ...
    it('should resolve a controller string address argument', function () {
      const { _id, address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100', protocol: 'tcp' } })
    ...
    it('should resolve a controller string address:port argument', function () {
      const { _id, address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100:12345', protocol: 'tcp' } })
  ...
  describe('resolve controller protocol', function () {
    it("should resolve a 'udp' controller protocol argument", function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100', protocol: 'udp' } })
    ...
    it("should resolve a 'tcp' controller protocol argument", function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100', protocol: 'tcp' } })
    ...
    it("should resolve a '' controller protocol argument", function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100', protocol: '' } })

      expect(protocol).to.equal('udp')
    })

    it("should resolve a 'weird' controller protocol argument", function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, address: '192.168.1.100', protocol: 'weird' } })

      expect(protocol).to.equal('udp')
    })

    it('should resolve a missing controller protocol argument', function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, addres: '192.168.1.100' } })

      expect(protocol).to.equal('udp')
    })

    it('should resolve a null controller protocol argument', function () {
      const { _id, _address, protocol } = resolve({ controller: { id: 405419896, addres: '192.168.1.100', protocol: null } })
