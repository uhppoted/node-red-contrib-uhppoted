  ...
  function RestoreDefaultParametersNode (config) {
    ...
    this.on('input', function (msg, send, done) {
      ...
      try {
        const context = {
          config: uhppote,
          translator: (k) => { return RED._('restore-default-parameters.' + k) },
          logger: (m) => { node.log(m) }
        }

        uhppoted.set(context, controller.controller, opcodes.RestoreDefaultParameters, {}, controller.address, controller.protocol)
