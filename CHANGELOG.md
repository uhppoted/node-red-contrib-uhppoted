...
## [1.1.12](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.12) - 2025-07-01

### Updated
1. Internal cleanups (minor).


## [1.1.11](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.11) - 2025-06-09
...
## [1.1.10](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.10) - 2025-02-12

### Updated
1. Fixed bug in 'connected UDP' logic (not using injected controller address:port).


## [1.1.9](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.9) - 2025-01-29

### Updated
1. Added auto-send interval to get/set-listener nodes.


## [1.1.8](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.8) - 2024-09-06
...
## [1.1.7](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.7) - 2024-03-26

### Added
1. `uhppoted-restore-default-parameters` node.


## [1.1.6](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.6) - 2023-12-01
...
## [1.1.5](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.5) - 2023-08-30

### Added
1. `uhppoted-activate-keypads` node.


## [1.1.4](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.4) - 2023-06-13

### Added
1. `uhppoted-set-interlock` node.


## [1.1.3](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.3) - 2023-03-17
...
## [1.1.2](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.2) - 2022-12-16
...
## [1.1.1](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.1) - 2022-10-14

### Changed
1. Added 'swipe open' and 'swipe close' event reasons.


## [1.1.0](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.1.0) - 2022-09-18
...
## [1.0.0](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v1.0.0) - 2022-09-10

### Removed
1. Removed all nodes without a _uhppote-_ prefix
2. Remove examples, dashboard and integration tests using deprecated nodes

## [0.9.1](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.9.1) - 2022-09-01
...
## [0.9.0](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.9.0) - 2022-08-27

### Changed
1. Created duplicate set of nodes with _uhppoted-_ prefix (cf. [Config node name conflict](https://github.com/uhppoted/uhppoted-lib-node-red/issues/11)
...
## [0.8.1](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.8.1) - 2022-08-01
...
## [0.7.3](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.7.3) - 2022-06-01

Updated dependencies.

## [0.7.2](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.7.2) - 2022-01-26
...
5. Throws an 'overwritten event' error if `get-event` retrieves an event that has been overwritten
   (cf. https://github.com/uhppoted/uhppoted-lib-node-red/issues/7)


## [v0.7.1](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.7.1) 
...
## [v0.7.0](https://github.com/uhppoted/uhppoted-lib-node-red/releases/tag/v0.7.0)
